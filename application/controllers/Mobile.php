...
class Mobile extends CI_Controller
{
    ...
    function get_image_url($type = '', $id = '') {
        ...
        if (file_exists($subdomain.'uploads/' . $type . '_image/' . $id . '.jpg'))
            $response['image_url'] = base_url().$subdomain.'uploads/' . $type . '_image/' . $id . '.jpg';
        else
            $response['image_url'] = base_url().$subdomain.'uploads/user.jpg';
        echo json_encode($response);
    }
    ...
    function update_user_image() {
        ...
        $subdomain = $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;
        $directory      =   $subdomain.'uploads/' . $user_type .  '_image/' . $user_id . '.jpg';
