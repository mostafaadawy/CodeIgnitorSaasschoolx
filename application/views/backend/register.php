...
<html>
  <head>
    ...
    <body class="auth-wrapper login" style="background: url('<?php echo base_url().$subdomain;?>uploads/bglogin.jpg');background-size: cover;background-repeat: no-repeat;">
  <script type="text/javascript">var baseurl = '<?php echo base_url();?>';</script>
      <div class="auth-box-w register" style="margin-bottom:2rem;">
        <div class="logo-wy">
          <a href="<?php echo base_url();?>"><img alt="" src="<?php echo base_url().$subdomain;?>uploads/logo-color.png" width="50%"></a>
        </div>
    <div class="content-i">
          ...
          <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-9">
              ...
              <input class="form-control" placeholder="<?php echo get_phrase('password');?>" id="tpassword" name="password" type="password">
              </div>
            </div>
           </div>
		    <div class="col-sm-9">
		   <input type="checkbox" onclick="TShowPassFunction()">Show Password
		   </div>
       <div class="buttons-w">
            <button class="btn btn-rounded btn-primary" type="submit"><?php echo get_phrase('create_account');?></button>
          </div>
          <?php echo form_close();?>
          </div>
    </div></div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
               <div class="input-group">
                 ...
                 <input class="form-control" placeholder="<?php echo get_phrase('username');?>" name="username" type="text">
               </div>
              </div>
            </div>
           <div class="form-group row">
       ...
       <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-9">
              ...
              <input class="form-control" placeholder="<?php echo get_phrase('password');?>" name="password" id="spassword" required type="password">
              </div>
            </div>
           </div>
		   <div class="col-sm-9">
		   <input type="checkbox" onclick="SShowPassFunction()">Show Password
		   </div>
       <div class="buttons-w">
            <button class="btn btn-rounded btn-primary" type="submit"><?php echo get_phrase('create_account');?></button>
          </div>
    ...
    <?php echo form_open(base_url() . 'register/create_account/parent/' , array('enctype' => 'multipart/form-data'));?>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-9">
              ...
              <input class="form-control" placeholder="<?php echo get_phrase('password');?>" name="password" id="ppassword" required="" type="password">
              </div>
            </div>
           </div>
		   <div class="col-sm-9">
		   <input type="checkbox" onclick="PShowPassFunction()">Show Password
		   </div>
       <div class="buttons-w">
            <button class="btn btn-rounded btn-primary"><?php echo get_phrase('create_account');?></button>
          </div>
          <?php echo form_close();?>
      </div>
    </div>
