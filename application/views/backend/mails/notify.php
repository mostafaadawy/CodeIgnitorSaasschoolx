...
<div width="100%" style="background: #39a2d9; padding: 0px; line-height:28px; height:100%;  width: 100%; color: #606060; ">
  ...
  <div style="vertical-align: top; padding-bottom:50px;padding-top:50px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);background: #001b3d;" align="center"><a href="#"><img src="<?php echo base_url().$subdomain;?>uploads/logo-white.png" alt="SchoolX | School System Management" style="border:none;max-width:75%"></a></div>
    ...
    <div style="text-align: center; font-size: 12px; color: #b2b2b5; margin-top: 20px; border-top: 1px solid rgba(0, 0, 0, 0.1); padding:5px;">
        <p> <img alt="" src="<?php echo base_url().$subdomain;?>uploads/logo-color.png" style="vertical-align: middle; height: 20px; width: auto;"> <?php echo $system_name;?><br>
    </div>
  </div>
</body>
</html>
