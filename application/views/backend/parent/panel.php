            ...
            <div class="content-box">			
			  ...
			  <div class="pipeline white lined-primary">
				...
				<?php 
	                ...
	                foreach($news as $new):
					if ($new['users'] == 'Admins' || $new['users'] == 'Teachers' || $new['users'] == 'Students') continue;?>
                  <div class="col-sm-6">
				...
				<?php endforeach;?>
                    </div><div class="legendy"><span><a class="btn btn-rounded btn-sm btn-primary" style="text-transform:uppercase;color:white;" href="<?php echo base_url();?>parents/noticeboard/"><?php echo get_phrase('view_more');?></a></span></div>
				   </div></div>
        ...
        <div class="element-box-content example-content">
		  ...
		  <div class="footy padded">
			<div class="schoollogo">
			  <img alt="" src="<?php echo base_url();?>style/cms/img/school1.png"><span><?php echo $this->db->get_where('settings', array('type' => 'system_title'))->row()->description;?></span>
			</div>
	  ...
	  $("#add").click(function()
	  {
	  	...
	  	if(answer!="" && poll_code!="")
	  	{
		  	$.ajax({url:"<?php echo base_url();?>parents/polls/response/",type:'POST',data:{answer:answer,poll_code:poll_code},success:function(result)
		  	{
        		 ...
        		 $("#message").val('');
        		 toastr.success(post_message, "Exit");
		    }});
	  	}
	  });
	});
