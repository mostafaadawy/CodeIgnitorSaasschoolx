                  ...
                  <h5 class="pipeline-name"><?php echo $new['title'];?></h5>
                    <div class="pipeline-header-numbers">
                     ...
                     <a href="<?php echo base_url();?>parents/read/<?php echo $new['news_code'];?>"> <div class="element-box" style="padding:0px">
                      <?php $file = base_url($subdomain.'uploads/news_images/'.$new['news_code'].'.jpg');?>
                      <?php if (@getimagesize($file)):?>
                        <div><img alt="" src="<?php echo base_url().$subdomain;?>uploads/news_images/<?php echo $new['news_code'];?>.jpg" width="100%"></div>
                      <?php endif;?>
