...
<ul class="breadcrumb hidden-xs-down hidden-sm-down">
  ...
  <?php $profile_info = $this->db->get_where('parent' , array('parent_id' => $this->session->userdata('login_user_id')))->result_array();
    ...
    <div class="user-profile compact">
      <div class="up-head-w" style="background-image:url(<?php echo base_url().$subdomain;?>uploads/back.jpg)">        
    ...
    <div class="user-avatar">
      ...
      foreach ($students as $subject): ?>
        ...
        <?php $class_id = $this->db->get_where('enroll', array('student_id' => $subject['student_id']))->row()->class_id;?>
          <td style="text-align: left;"><img alt="" src="<?php echo base_url().$subdomain;?>uploads/student_image/<?php echo $subject['student_id'];?>.jpg" width="25px" style="border-radius: 10px;margin-right:5px;"><?php echo $subject['name'];?></td>
    ...
    <div class="element-wrapper">
      <div class="element-box">
        ...
        <div class="form-group">
          ...
          <input class="form-control" placeholder="" value="<?php echo $row3['name'];?>" name="name" type="text" readonly>
          </div>
        </div>
        <div class="row">
        <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control"  value="<?php echo $row3['username'];?>" type="text">
          </div>
          </div>
        </div>
        <div class="col-sm-6">  
        ...
        <label class="col-form-label" for=""> <?php echo get_phrase('update_password');?></label>
          ...
          <input class="form-control" placeholder="<?php echo get_phrase('new_password');?>" name="password"  id="password" type="password">
        ...
        <label class="col-form-label" for=""> <?php echo get_phrase('photo');?></label>
          ...
          <button type="button" class="avatar-preview avatar-preview-128">
				<img id="ava" src="<?php echo base_url().$subdomain;?>uploads/parent_image/<?php echo $row['parent_id'];?>.jpg" alt=""/>
				<span class="update">
