...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
          ...
          <div class="menu-and-user">
            ...
            <ul class="main-menu">
              ...
              <li class="main-menu <?php if($page_name == 'exam_results' || $page_name == 'online_exams' || $page_name == 'homework' || $page_name == 'study_material' || $page_name == 'syllabus' || $page_name == 'homework_room') echo 'active';?>">
                <a href="<?php echo base_url();?>parents/homework/">
                  <div class="icon-w">
			  ...
			  <li class="main-menu <?php if($page_name == 'school_bus') echo 'active';?>">
                <a href="<?php echo base_url();?>parents/school_bus/">
                  <div class="icon-w">
        ...
        <div class="desktop-menu menu-side-w menu-activated-on-click color-scheme-dark">
          <div class="logo-w">
            <a class="logo" href="<?php echo base_url();?>parents/panel/"><img src="<?php echo base_url().$subdomain;?>uploads/logo-white.png"></a>
          </div>
          <div class="menu-and-user">
