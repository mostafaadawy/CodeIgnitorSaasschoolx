...
<div class="content-w">
	...
	<div class="os-tabs-w">
        						...
        						<tbody>
        							<?php 
										...
										$students = $this->db->get_where('subject', array('subject_id' => $row3['subject_id'], 'year' => $running_year))->row()->students;
											...
											if(!$type ==1  || strpos($students ,'"'.$row1['student_id'].'"' )!= false ):
            ...
            <?php if($mark < $min || $mark == 0):?>
              ...
              <td><?php echo $grade = $this->crud_model->get_grade($this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'exam_id' => $row2['exam_id'], 'student_id' => $row1['student_id'], 'year' => $running_year))->row()->labtotal , $row3['class_id'] , $row3['subject_id'] );?></td>
