		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big">
				<?php echo get_phrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().$subdomain.'uploads/homework/' . $row['file_name']; ?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
			</div>
			<?php endif;?>
		...
		<div class="pipeline white lined-secondary">
		  ...
		  <table class="table table-lightbor table-lightfont">
			  ...
			  <tr>
				...
				<?php endif;?>
				<?php if($query->num_rows() > 0):?>
				  <a class="btn btn-rounded btn-sm btn-primary" style="color:white"><?php echo $this->db->get_where('deliveries', array('homework_code' => $homework, 'student_id' => $student))->row()->mark;?></a>
				<?php endif;?>
				</td>
			  </tr>
			   <tr>
				...
				<td>
				<?php if($query->num_rows() > 0):?>
				  <?php echo $this->db->get_where('deliveries', array('homework_code' => $homework, 'student_id' => $student))->row()->teacher_comment;?>
				<?php endif;?>
				</td>
			  </tr>
		  </table>
