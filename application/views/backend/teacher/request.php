		  ...
		  <div class="table-responsive">
        	...
        	?>   
				<tr>
					...
					<?php endif;?>
					<?php if($row['file'] != ""):?>
						<a href="<?php echo base_url().$subdomain;?>uploads/request/<?php echo $row['file'];?>" class="btn btn-rounded btn-sm btn-primary" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a>
					<?php endif;?>
					</td>
					<td>
                    <?php if($row['status'] == 0):?>
          ...
          <div class="element-wrapper">
            <div class="element-box lined-primary">
			  ...
			  <div class="row">
				  <div class="col-sm-6">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('from');?></label><input required class="form-control" type="text" value="" name="start_date" id="start_date">
					</div>
				  </div>
				  <div class="col-sm-6">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('until');?></label><input class="form-control" type="text" required="" name="end_date" id="end_date" value="">
					</div>
				  </div>
				</div>
				<div class="form-group">
