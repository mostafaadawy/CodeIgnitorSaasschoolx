        	...
        	?>
				...
				<tr>
					...
					<td class="row-actions">
						<a href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $row['homework_code'];?>"><button class="btn btn-primary btn-rounded btn-sm"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i><?php echo get_phrase('view');?></button></a>
...
<br>
        ...
        <label class="col-form-label"> <?php echo get_phrase('homework_type');?></label>
          ...
          <label class="form-check-label" ><input class="form-check-input" name="type" type="radio" value="1" required><?php echo get_phrase('online_text');?></label>
          <label class="form-check-label" ><input class="form-check-input" name="type" type="radio" value="2" required style="margin-left:5px;"><?php echo get_phrase('files');?></label>
          </div>
        </div></center>
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
				  <label for=""> <?php echo get_phrase('delivery_date');?></label><input class="form-control" required="" type="text" name="date_end" id="end_date" value="">
				</div>
				 <div class="form-group">
