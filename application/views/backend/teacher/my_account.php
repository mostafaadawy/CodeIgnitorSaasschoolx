    ...
    <div class="element-wrapper">
      <div class="element-box">
        ...
        <div class="form-group">
          ...
          <input class="form-control" value="<?php echo $row3['birthday'];?>" name="birthday" id="birthday" type="text" value="">
          </div>
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <label class="col-form-label" for=""> <?php echo get_phrase('photo');?></label>
          ...
          <button type="button" class="avatar-preview avatar-preview-128">
				<img id="ava" src="<?php echo base_url().$subdomain;?>uploads/teacher_image/<?php echo $row['teacher_id'];?>.jpg" alt=""/>
				<span class="update">
