  ...
  <div class="content-i">
	...
	<div class="col-sm-8">
		  ...
		  <div class="pipeline-header">
			...
			<?php echo form_open(base_url() . 'teacher/homework/update/' . $homework_code, array('enctype' => 'multipart/form-data')); ?>
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
				  <label for=""> <?php echo get_phrase('delivery_date');?></label><input class="form-control" name="date_end" id="end_date" type="text" required="" value="<?php echo $row['date_end'];?>">
				</div>
				 <div class="form-group">
        ...
        <label class="col-form-label"> <?php echo get_phrase('delivery_type');?></label>
          ...
          <label class="form-check-label"><input class="form-check-input" name="type" type="radio" value="1" required <?php if($row['type'] == 1) echo 'checked';?>><?php echo get_phrase('online_text');?></label>
          <label class="form-check-label"><input class="form-check-input" name="type" type="radio" value="2" required style="margin-left:5px;" <?php if($row['type'] == 2) echo 'checked';?>><?php echo get_phrase('files');?></label>
          </div>
        </div></center>
