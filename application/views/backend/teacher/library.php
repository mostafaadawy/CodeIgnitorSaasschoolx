		  ...
		  <div class="table-responsive">
			...
			<tr>
				...
				<?php if($row['type'] == 'virtual'):?>
					<a class="btn nc btn-rounded btn-sm btn-purple" style="color:white"><?php echo 'eBook';?></a>
				<?php endif;?>
				<?php if($row['type'] == 'normal'):?>
					<a class="btn nc btn-rounded btn-sm btn-info" style="color:white"><?php echo 'Hard Cover';?></a>
				<?php endif;?>
				</td>
				...
				<?php if($row['type'] == 'virtual' && $row['file_name'] != ""):?>
					<a class="btn btn-rounded btn-sm btn-primary" style="color:white" href="<?php echo base_url().$subdomain;?>uploads/library/<?php echo $row['file_name'];?>"><i class="picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a>
				<?php endif;?>
				<?php if($row['type'] == 'normal'):?>
		  ...
		  <div class="form-group row">
			...
			<div class="form-group row">
			  ...
			  <div class="form-group row">
				...
				<div class="col-sm-9">
				  <div class="form-check">
					<label class="form-check-label"><input class="form-check-input" name="type" type="radio" value="virtual"><?php 'eBook';?></label>
					<label class="form-check-label"><input class="form-check-input" checked="" name="type" type="radio" value="normal" style="margin-left:5px;"><?php echo 'Hard Cover';?></label>
				  </div>
				</div>
			  </div>
			  <div class="form-group row">
