    ...
    <div class="col-sm-12">
     ...
     <div class="pipeline-item">
      ...
      <div class="pi-info">
        ...
        <small><?php echo get_phrase('roll').': '.$row['roll'];?></small>
        </div>
        <div class="pi-sub">
      ...
      <table class="table table-lightborder">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $grade = $this->crud_model->get_grade($this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'exam_id' => $row2['exam_id'], 'student_id' => $student_id, 'year' => $running_year))->row()->labtotal , $class_id , $row3['subject_id'] );?></td>
