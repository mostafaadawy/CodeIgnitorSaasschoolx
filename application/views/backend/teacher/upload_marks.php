              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <select name="class_id" id="class_id" class="form-control" onchange="get_class_sections(this.value); get_class_subject(this.value, section_selector_holder.value)" required="">
						<option value=""><?php echo get_phrase('select');?></option>
						<?php
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <label class="gi" for=""><?php echo get_phrase('section');?>:</label>
                    	<select class="form-control" onchange="get_class_subject(class_id.value, this.value);"  required="" id="section_selector_holder" name="section_id">
							<option value=""><?php echo get_phrase('select');?></option>
						</select>
                  </div>
                </div>
