...
<div class="content-w">
	...
	<div class="back">
		<button onclick="goBack()" ><i class="os-icon os-icon-common-07"  ></i></button>
	</div>
	</ul>
  <div class="content-i">
		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big">
				<?php echo get_phrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().$subdomain;?>uploads/report_files/<?php echo $row['file'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a>
			</div>
                         <?php endif;?>
		</div>
