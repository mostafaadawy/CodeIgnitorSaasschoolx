                    ...
                    <tr>
                      ...
                      <td>
                      	...
                      	<?php if($type == 2 && $row['file_name'] != ""):?>
                        	<a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().$subdomain;?>uploads/homework_delivery/<?php echo $row['file_name'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                        <?php endif;?>
