      ...
      <div class="element-box shadow lined-primary">
        ...
        <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
		  ...
		  <?php if($row['admin_id'] != 1):?>
            <tr>
              <td><img alt="" src="<?php echo base_url().$subdomain;?>uploads/admin_image/<?php echo $row['admin_id'];?>.jpg" width="25px" style="border-radius: 10px;margin-right:5px;"> <?php echo $row['name']; ?></td>
      ...
      <?php echo form_open(base_url() . 'admin/admins/create/' , array('enctype' => 'multipart/form-data'));?>
        ...
        <div class="form-group row">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="<?php echo get_phrase('username');?>" id="username" name="username" required="" type="text" onkeypress="check_if_exists();">
          </div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <input class="form-control" name="birthday" id="birthday" type="text" value="">
          </div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <h3><?php echo get_phrase('user_permissions');?></h3>
		<h5><?php echo '(Privileges will be enabled for purchased modules only)';?></h5><br>
...
function check_if_exists() {
     ...
     $.ajax({
     url: baseurl + "index.php?login/user_exists",
     type: "post",
     data: {
