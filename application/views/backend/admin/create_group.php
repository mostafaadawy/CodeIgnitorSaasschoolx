...
<?php
    ...
    <div class="col-md-12" style="margin-top: 10px;">
      <table  class="table table-bordered table-striped">
        ...
        <span class="col-md-4 pull-right" style="text-align: right; color: #616161;">
          <input type="checkbox" id = "<?php echo $user_array[$i]; ?>" onchange="checkAllBoxes(this)">&nbsp;Select all
        </span>
        <thead>
          <tr>
            <th>Select</th>
  ...
  <div class="pull-right">
    <button type="submit" name="submit" class="btn btn-success btn-md">Create group</button>
  </div>
</form>
