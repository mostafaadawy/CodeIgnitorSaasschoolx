  ...
  <div class="content-i">
	...
	<div class="col-sm-8">
        ...
        <label class="col-form-label"> <?php echo get_phrase('delivery_type');?></label>
          ...
          <label class="form-check-label"><input class="form-check-input" name="type" required type="radio" value="1" <?php if($row['type'] == 1) echo 'checked';?>><?php echo get_phrase('online_text');?></label>
          <label class="form-check-label"><input class="form-check-input" name="type" required type="radio" value="2" style="margin-left:5px;" <?php if($row['type'] == 2) echo 'checked';?>><?php echo get_phrase('files');?></label>
          </div>
        </div></center>
