		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<?php if($row['file_name'] != ""):?>
				Archivo: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().$subdomain;?>uploads/forum/<?php echo $row['file_name'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a></td>
			<?php endif;?>
			</div>
		</div>
