		...
		<div class="invoice-w">
		  <div class="infos">
			<div class="info-1">
			  <div class="invoice-logo-w">
				<img alt="" src="<?php echo base_url().$subdomain;?>uploads/logo.png" width="35%" height="35%">
			  </div>
		  ...
		  <div class="invoice-footer">
			<div class="invoice-logo">
			  <img alt="" src="<?php echo base_url().$subdomain;?>uploads/logo.png"><span><?php echo $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;?></span>
			</div>
