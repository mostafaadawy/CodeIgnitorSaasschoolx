...
<?php $subdomain = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->subdomain;?>
                    <div class="full-chat-middle" id="full-chat-middle">
                    <div class="chat-head">
                      <div class="user-info">
                          ...
                          <div class="chat-message-content-w">
                            <div class="chat-message-content">
                              ...
                              <?php if($row['file_name'] != ""):?>
                                 <a class="btn btn-sm btn-rounded btn-success" href="<?php echo base_url().$subdomain;?>uploads/messages/<?php echo $row['file_name']; ?>" style="color:white"><i class="picons-thin-icon-thin-0105_download_clipboard_box"></i>&nbsp;&nbsp;<?php echo get_phrase('download');?></a>
								  <div class="logo-wy">
                    ...
                    <?php echo form_open(base_url() . 'admin/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
                      ...
                      <div class="chat-input-extra">
                       <div class="chat-extra-actions">
                           <input type="file" name="file_name"  onclick="ToggleRequiredFunction()"  id="file-3" class="inputfile inputfile-3" style="display:flex"/>
                        ...
                        <div class="chat-btn">
                          <button class="btn btn-rounded btn-primary"  id="send" type="submit"><?php echo get_phrase('send');?></button>
                        </div>
                      </div>
                      <?php echo form_close();?>
                    </div>
