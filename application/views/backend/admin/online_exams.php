			...
			<?php
				...
				<tr>
					...
					<td class="row-actions"> 
						<a href="<?php echo base_url();?>admin/examroom/<?php echo $row['exam_code'];?>"><button class="btn btn-primary btn-rounded btn-sm"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i><?php echo get_phrase('edit');?></button></a>
          ...
          <div class="modal-body">
            <?php echo form_open(base_url() . 'admin/create_exam/create/' , array('enctype' => 'multipart/form-data'));?>
			  ...
			  <div class="row">
				  <div class="col-sm-3">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('start_date');?></label><input class=" form-control" required="" name="availablefrom" id="availablefrom" type="text" value="" onBlur="getminenddate">
					</div>
				  </div>
				  <div class="col-sm-3">
				  ...
				  <div class="col-sm-3">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('end_date');?></label><input class="form-control" name="availableto" id="availableto" required type="text" value="" onClick="getminenddate">
					</div>
				  </div>
				  <div class="col-sm-3">
