...
<div class="content-w">
 ...
 <div class="content-i">
    ...
    <?php echo form_open(base_url() . 'admin/attendance_teacher/', array('class' => 'form m-b'));?>
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group"> <label class="gi" for=""><?php echo get_phrase('date');?>:</label> <input class="single-daterange form-control" placeholder="Date" name="timestamp" type="text" required value="<?php echo date("d/m/y", $timestamp);?>"> </div>
        </div>
