     ...
     <div class="content-i">
         ...
         <div class="element-box shadow lined-primary">
           <div class="table-responsive">
            <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
               ...
               ?>
                  <tr>
				      <td><input type="checkbox" class="sub_chk" data-id="<?php echo $row['teacher_id']; ?>"></td>
                     ...
                     <td><div class="pt-btn"><a class="btn nc btn-success btn-sm btn-rounded"><font color="white">EGP<?php echo $row['salary']; ?></font></a></div></td>
         ...
         <?php echo form_open(base_url() . 'admin/teachers/create/' , array('enctype' => 'multipart/form-data'));?>
           ...
           <div class="form-group row">
              ...
              <div class="col-sm-9">
               ...
               <input class="form-control" name="birthday"  id="birthday" placeholder="Select Date of Birth" type="text" value="">
               </div>
              </div>
            </div>
           <div class="form-group row">
	  ...
	  <h6 class="form-header">
       <?php echo 'All fields of the Excel Sheet are required. Blank fields and/or duplicate user-names are not allowed!!';?>
        ...
        <div class="text-right" style="margin-top:-25px;margin-bottom:25px;"><a href="<?php echo base_url();?>uploads/import/teachers_excel.xlsx"><button class="btn btn-primary btn-rounded btn-sm"><i class="picons-thin-icon-thin-0105_download_clipboard_box"></i>  <?php echo get_phrase('download_model');?></button></a></div>
		</div>
		<div style="margin:30px 10px;">
      <?php echo form_open(base_url() . 'admin/teacher_bulk/excel/' , array('class' => 'form-inline', 'enctype' => 'multipart/form-data'));?>
        ...
        $('.delete_all').on('click', function(e) {
            ...
            {  
                ...
                if(check == true){  
                    ...
                    $.ajax({
                        url: "<?php echo base_url();?>admin/delete_multiple_teachers/",
                        type: 'POST',
