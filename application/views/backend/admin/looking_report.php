		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big">
                     <?php if( $row['file'] != ""):?>
				<?php echo get_phrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().$subdomain;?>uploads/report_files/<?php echo $row['file'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('download');?></a><?php endif;?>
			...
			<?php if($row['approved'] == 0):?><br><br>
			 <div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success" onClick="return confirm('<?php echo get_phrase('confirm_approval');?>')" href="<?php echo base_url();?>admin/create_report/approve/<?php echo $row['code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo get_phrase('approve_send');?></a></div>
			<?php endif;?>
