    ...
    <div class="element-wrapper">
      ...
      <?php echo form_open(base_url() . 'admin/student/do_update/'.$row3['student_id'] , array('id' => 'formValidate', 'enctype' => 'multipart/form-data'));?>
        ...
        <div class="form-group">
          ...
          <input class="form-control" value="<?php echo $row3['birthday'];?>" name="birthday" id="birthday" type="text" >
          </div>
          </div>
        </div>
        <div class="col-sm-6">        
        ...
        <label class="col-form-label" for=""> <?php echo get_phrase('photo');?></label>
          ...
          <button type="button" class="avatar-preview avatar-preview-128">
				<img id="ava" src="<?php echo base_url().$subdomain;?>uploads/student_image/<?php echo $row['student_id'];?>.jpg" alt=""/>
				<span class="update">
