		  ...
		  <div class="table-responsive">
			...
			<tr>
				...
				<?php if($row['type'] == 'normal'):?>
					<a class="btn btn-rounded btn-sm btn-info" style="color:white"><?php echo 'Hard Cover';?></a>
				<?php endif;?>
				</td>
		  ...
		  <div class="form-group row">
			...
			<div class="form-group row">
			  ...
			  <div class="input-group">
				...
				<input class="form-control" placeholder="99" name="price" type="number">
				</div>
			  </div>
			</div>
			<div class="form-group row">
			  ...
			  <div class="form-group row">
				...
				<div class="col-sm-9">
				  <div class="form-check">
					<label class="form-check-label"><input class="form-check-input" name="type" type="radio" value="virtual"><?php echo 'eBook';?></label>
