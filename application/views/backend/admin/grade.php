 ...
 <div class="content-i">
  ...
  <div class="element-wrapper">
    <div class="element-box lined-primary shadow">
	  ...
	  $subject = $this->db->get_where('subject', array('subject_id'=> $row['subject_id']))->row()->name;
      ?>
        <tr>
  ...
  <div class="element-wrapper">
    ...
    <?php echo form_open(base_url() . 'admin/grade/create/');?>
      <h5 class="form-header"><?php echo get_phrase('add');?></h5><br>
				...
				<label class="col-sm-3  col-form-label" for=""><?php echo get_phrase('class');?></label>
				   <div class="col-sm-9">
					<div class="input-group">
					<div class="input-group-addon">
						<i class="os-icon picons-thin-icon-thin-0003_write_pencil_new_edit"></i>
					</div>
				   <select name="class_id" class="form-control" id="class_id" onchange="get_class_subject(this.value);">
				...
				<label class="col-sm-3 col-form-label" for=""><?php echo get_phrase('subject');?></label>
				  ...
				  <select class="form-control" id="subject_selector_holder" required="" name="subject_id[]" multiple>
					<option value=""><?php echo get_phrase('select');?></option>
				  </select>
				  </div>
			  </div>
