	...
	<div class="row">
      ...
      <div class="element-box lined-success shadow">
		  <h5 class="form-header"><?php echo get_phrase('system_settings');?></h5><br>
			...
			<label class="col-form-label col-sm-3" for=""> <?php echo "School Name";?></label>
			  <div class="col-sm-9">
				...
				<div class="col-sm-9">
				  ...
				  <select class="form-control" name="language">
					 ...
					 <?php $fields = $this->db->list_fields('language');
                        ...
                        {
                    		if ($field == 'phrase_id' || $field == 'phrase' || $field == 'spanish' || $field == 'portuguese' || $field == 'hindi' || $field == 'serbian') continue;
			...
			<label class="col-form-label col-sm-3" for=""> <?php echo get_phrase('currency');?></label>
			  ...
			  <input class="form-control" name="currency" placeholder="EGP" value="<?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?>" type="text">
			  </div>
			</div></div>
			<div class="form-group row">
					...
					<?php $running_year = $this->db->get_where('settings' , array('type'=>'running_year'))->row()->description;?>
                          ...
                          <?php for($i = 0; $i < 10; $i++):?>
                              <option value="<?php echo (2018+$i);?>-<?php echo (2018+$i+1);?>"
                                <?php if($running_year == (2018+$i).'-'.(2018+$i+1)) echo 'selected';?>>
      ...
      <div class="element-box lined-primary shadow">
		  <h5 class="form-header"><?php echo get_phrase('system_settings');?></h5><br>
			...
			<label class="col-form-label col-sm-3" for=""> <?php echo get_phrase('email');?></label>
			 ...
			 <div class="form-group row">
            <label class="col-sm-4 col-form-label">Enable user registration</label>
            <div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label class="col-form-label" for="">School Logo</label>
				  <div class="newsfe centry">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="logo" src="<?php echo base_url().$subdomain;?>uploads/logo.png"></div>
				</div>
			 </div></div>
			 <div class="col-sm-3">
			  <div class="form-group">
				<label class="col-form-label" for="">System Logo Color</label>
				  <div class="newsfe centry">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="logocolor" src="<?php echo base_url().$subdomain;?>uploads/logo-color.png"></div>
				</div>
			 </div></div>
			 <div class="col-sm-3">
			 <div class="form-group">
				<label class="col-form-label" for="">System Logo White</label>
				  <div class="newsfe centry" style="background-color:#001b3d;">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="logow" src="<?php echo base_url().$subdomain;?>uploads/logo-white.png"></div>
				</div>
			 </div></div>			 
			 <div class="col-sm-2">
			  <div class="form-group">
				<label class="col-form-label" for="">Avatar</label>
				  <div class="newsfe centry">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="avatar" src="<?php echo base_url().$subdomain;?>uploads/user.jpg"></div>
				</div>
			 </div></div>
			 <div class="col-sm-1">
			 <div class="form-group">
				<label class="col-form-label" for="">Icon W</label>
				  <div class="newsfe centry" style="background-color:#001b3d;">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="iconw" src="<?php echo base_url().$subdomain;?>uploads/logo-icon.png"></div>
				</div>
			 </div></div>
			 <div class="col-sm-1">
			  <div class="form-group">
				<label class="col-form-label" for="">Favicon</label>
				  <div class="newsfe centry">
					...
					<div class="margin:0 auto"><img width="100%" height="100%" id="favicon" src="<?php echo base_url().$subdomain;?>uploads/favicon.png"></div>
				</div>
			 </div></div>
			 </div>
			 ...
			 <div class="form-group">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 1</label>
				  <div class="themsy">
					...
					<img width="100%" src="<?php echo base_url().$subdomain;?>uploads/theme1.jpg">
				</div>
			 </div></div>
			 <div class="col-sm-2">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 2</label>
				  <div class="themsy">
					...
					<img width="100%" src="<?php echo base_url().$subdomain;?>uploads/theme2.jpg">
				</div></div>
			 <div class="col-sm-2">
			 <div class="form-group">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 3</label>
				  <div class="themsy">
					...
					<img width="100%" height="100%" src="<?php echo base_url().$subdomain;?>uploads/theme3.jpg">
				</div>
			 </div></div>
			 <div class="col-sm-2">
			 <div class="form-group">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 4</label>
				  <div class="themsy">
					...
					<img width="100%" height="100%" src="<?php echo base_url().$subdomain;?>uploads/theme4.jpg">
				</div>
			 </div></div>
			 <div class="col-sm-2">
			 <div class="form-group">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 5</label>
				  <div class="themsy">
					...
					<img width="100%" height="100%" src="<?php echo base_url().$subdomain;?>uploads/theme5.jpg">
				</div>
			 </div></div>
			 <div class="col-sm-2">
			 <div class="form-group">
				<label class="col-form-label" for=""><?php echo get_phrase('theme');?> 6</label>
				  <div class="themsy">
					...
					<img width="100%" height="100%" src="<?php echo base_url().$subdomain;?>uploads/theme6.jpg">
				</div>
			 </div></div>
			 </div>
			  ...
			  <div class="form-group">
				<label class="col-form-label" for="">Slider 1</label>
				  <div class="newsfe">
					...
					<img width="100%" height="100%" id="slider1" src="<?php echo base_url().$subdomain;?>uploads/slider/slider1.png">
				</div>
			 </div></div>
			 <div class="col-sm-4">
			  <div class="form-group">
				<label class="col-form-label" for="">Slider 2</label>
				  <div class="newsfe">
					...
					<img width="100%" height="100%" id="slider2" src="<?php echo base_url().$subdomain;?>uploads/slider/slider2.png">
				</div>
			 </div></div>
			 <div class="col-sm-4">
			 <div class="form-group">
				<label class="col-form-label" for="">Slider 3</label>
				  <div class="newsfe">
					...
					<img width="100%" height="100%" id="slider3" src="<?php echo base_url().$subdomain;?>uploads/slider/slider3.png">
				</div>
			 </div></div>
			 </div>
			  ...
			  <div class="form-group">
				<label class="col-form-label" for="">Background Image</label>
				  <div class="newsfe">
					...
					<img width="100%" height="100%" id="bglogin" src="<?php //echo base_url().$subdomain;?>uploads/bglogin.jpg">
				</div>
			 </div></div>
