...
<div class="content-w">
    ...
    <div class="content-box">
        						...
        						<tbody>
        							<?php 
                            			...
                            			foreach ($subjects as $row3): 
										 if(!$row3['type'] ==1  || strpos($row3['students'] ,'"'.$student_id.'"' )!= false ):
            ...
            <?php if($mark < $min || $mark == 0):?>
              ...
              <?php endif;?></td>
              <td><?php echo $grade = $this->crud_model->get_grade($this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'exam_id' => $row2['exam_id'], 'student_id' => $this->session->userdata('login_user_id'), 'year' => $running_year))->row()->labtotal , $row3['class_id'] ,$row3['subject_id']);?></td>
