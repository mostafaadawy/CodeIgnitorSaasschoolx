                          ...
                          <div class="chat-message-content-w">
                            <div class="chat-message-content">
                              ...
                              <?php if($row['attached_file_name'] != ""):?>
                                 <a class="btn btn-sm btn-rounded btn-success" href="<?php echo base_url().$subdomain;?>uploads/group_messaging_attached_file/<?php echo $row['attached_file_name'];?>" style="color:white"><i class="picons-thin-icon-thin-0105_download_clipboard_box"></i>&nbsp;&nbsp;<?php echo get_phrase('download');?></a>
								  <div class="logo-wy">
                        ...
                        <div class="chat-message self">
                          <div class="chat-message-content-w">
                            <div class="chat-message-content">
                              <?php echo $row['message']; ?>
                              <?php if($row['attached_file_name'] != ""):?>
                                 <a class="btn btn-sm btn-rounded btn-success" href="<?php echo base_url().$subdomain;?>uploads/group_messaging_attached_file/<?php echo $row['attached_file_name'];?>" style="color:white"><i class="picons-thin-icon-thin-0121_download_file"></i>&nbsp;&nbsp;<?php echo get_phrase('download');?></a>
								  <div class="logo-wy">
								 <img alt="" width="50%" href="<?php echo base_url().$subdomain;?>uploads/messages/<?php echo $row['file_name']; ?>" src="<?php echo base_url().$subdomain;?>uploads/messages/<?php echo $row['file_name']; ?>">
								 </div>
                              <?php endif;?>
