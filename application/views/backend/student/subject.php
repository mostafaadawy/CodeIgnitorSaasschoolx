<?php
	...
	$class = $this->db->get_where('enroll', array('student_id' => $student_id ))->row()->class_id;
		  ...
		  <div class="table-responsive">
			...
			$subjects = $this->db->get_where('subject', array('class_id' => $class, 'year' => $year))->result_array();
				...
				foreach($subjects as $row):
				   if(!$row['type'] ==1  || strpos($row['students'] ,'"'.$student_id.'"' )!= false ):
			?>
				...
				<tr>
					...
					<td><?php if($row['type'] != '1'):?>
                        <a class="btn nc btn-rounded btn-sm btn-danger" style="color:white"><?php echo 'Obligatory';?></a>
                    <?php endif;?>
                    <?php if($row['type'] == '1'):?>
                        <a class="btn nc btn-rounded btn-sm btn-success" style="color:white"><?php echo 'Selective';?></a>
                    <?php endif;?>	</td>
