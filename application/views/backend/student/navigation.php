...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
          ...
          <div class="menu-and-user">
            ...
            <ul class="main-menu">
			  ...
			  <li class="main-menu <?php if($page_name == 'calendar') echo 'active';?>">
                <a href="<?php echo base_url();?>student/calendar/">
                  ...
                  <span><?php echo get_phrase('academic_calendar');?></span></a>
              </li>
              ...
              <li class="main-menu <?php if($page_name == 'my_marks' || $page_name == 'subject_marks') echo 'active';?>">
               ...
               <li class="main-menu <?php if( $page_name == 'homework' || $page_name == 'study_material' || $page_name == 'syllabus' || $page_name == 'online_exams' || $page_name == 'forum' || $page_name == 'homework_room' || $page_name == 'exam_results' || $page_name == 'examroom' || $page_name == 'forum_room') echo 'active';?>">
			  ...
			  <?php endif;?>
			   <li class="main-menu <?php if($page_name == 'school_bus') echo 'active';?>">
                <a href="<?php echo base_url();?>student/school_bus/">
                  <div class="icon-w">
        ...
        <div class="desktop-menu menu-side-w menu-activated-on-click color-scheme-dark">
          <div class="logo-w">
            <a class="logo" href="<?php echo base_url();?>student/panel/"><img src="<?php echo base_url().$subdomain;?>uploads/logo-white.png"></a>
          </div>
          <div class="menu-and-user">
